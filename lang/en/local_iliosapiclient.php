...
$string['errorresponsewithcodeandmessage'] = 'Request failed. The API responded with the following error: {$a}.';
$string['errorresponsewitherror'] = 'Request failed. The API responded with the code: {$a->code} and message: {$a->message}.';
